        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-600">Registro completo de temperatura y humedad</p>
            </div>
            <button
            ...
            <table className="w-full">
              <thead className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white">
                <tr>
                  ...
                  <th className="px-6 py-4 text-left font-bold">Fecha y Hora</th>
                  <th className="px-6 py-4 text-center font-bold">Temperatura (°C)</th>
                  <th className="px-6 py-4 text-center font-bold">Humedad (%)</th>
                ...
                {isLoading ? (
                  ...
                  <tr>
                    <td colSpan="5" className="px-6 py-12 text-center text-gray-500">
                      ...
                      <p className="font-semibold text-lg">No hay datos disponibles</p>
                      <p className="text-sm mt-2">
                        Los datos se mostrarán aquí una vez que tu circuito comience a enviar información
                      </p>
                    </td>
                  </tr>
                ) : (
